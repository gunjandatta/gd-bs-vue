...
var Carousel = /** @class */ (function (_super) {
    ...
    function Carousel() {
        ...
        _this._bs = gd_bs_1.Components.Carousel;
        return _this;
    }
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], Carousel.prototype, "enableControls", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], Carousel.prototype, "enableCrossfade", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], Carousel.prototype, "enableIndicators", void 0);
    __decorate([
        vue_property_decorator_1.Prop(String)
    ], Carousel.prototype, "id", void 0);
    __decorate([
