...
var CheckboxGroup = /** @class */ (function (_super) {
    ...
    function CheckboxGroup() {
        ...
        _this._bs = gd_bs_1.Components.CheckboxGroup;
        return _this;
    }
    __decorate([
        vue_property_decorator_1.Prop(Number)
    ], CheckboxGroup.prototype, "colSize", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], CheckboxGroup.prototype, "hideLabel", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], CheckboxGroup.prototype, "isInline", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], CheckboxGroup.prototype, "isReadonly", void 0);
    __decorate([
        vue_property_decorator_1.Prop(String)
    ], CheckboxGroup.prototype, "label", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Array)
    ], CheckboxGroup.prototype, "items", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], CheckboxGroup.prototype, "multi", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Function)
    ], CheckboxGroup.prototype, "onRender", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Function)
    ], CheckboxGroup.prototype, "onChange", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], CheckboxGroup.prototype, "renderRow", void 0);
    __decorate([
        vue_property_decorator_1.Prop(String)
    ], CheckboxGroup.prototype, "title", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Number)
    ], CheckboxGroup.prototype, "type", void 0);
    __decorate([
