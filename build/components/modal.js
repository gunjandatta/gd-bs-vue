...
var Modal = /** @class */ (function (_super) {
    ...
    function Modal() {
        ...
        _this._bs = gd_bs_1.Components.Modal;
        return _this;
    }
    __decorate([
        vue_property_decorator_1.Prop([String, Element])
    ], Modal.prototype, "body", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], Modal.prototype, "disableFade", void 0);
    __decorate([
        vue_property_decorator_1.Prop([String, Element])
    ...
    ], Modal.prototype, "id", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], Modal.prototype, "isCentered", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Boolean)
    ], Modal.prototype, "isStatic", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Function)
    ], Modal.prototype, "onClose", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Function)
    ], Modal.prototype, "onRenderBody", void 0);
    __decorate([
        vue_property_decorator_1.Prop(Function)
    ], Modal.prototype, "onRenderFooter", void 0);
    __decorate([
